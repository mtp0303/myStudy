...
$member_data = $member_log->getMemberList();
$page = empty($_GET['page']) ? 1 : $_GET['page'];
$list = $member_log->makeMemberList($member_data, $page);
$pagenation = $member_log->pagenation($member_data, 'memberList')
?>
<!doctype html>
<html>
	<head>
		...
		<div class="container-fluid overflow-hidden" id="first_page" style="padding: 0px 0px;">
			...
			<div class="row justify-content-center align-items-center" id="board_table" style="height: 80vh;">
				<div class="col-6 align-self-center">
					<h1 class="text-center display-3">Member List</h1>
